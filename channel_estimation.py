...
H_est=H_est/1100
plt.plot(pilotIndice, abs(H_est), label='Pilot estimates')
...
#Hest_abs = scipy.interpolate.interp1d(pilotIndice, abs(H_est), kind='linear')(allIndice)
#Hest_phase = scipy.interpolate.interp1d(pilotIndice, np.angle(H_est), kind='linear')(allIndice)
